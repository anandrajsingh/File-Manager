...
public class InternalFragment : Fragment(), OnFileSelectedListener {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        view1 = inflater.inflate(R.layout.fragment_internal, container, false)

        view1 = inflater.inflate(R.layout.fragment_internal, container, false)

        tvPathHolder = view1.findViewById(R.id.tv_path_holder)
        imgBack = view1.findViewById(R.id.image_back)
